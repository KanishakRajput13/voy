...
import com.kanishak.voy.R.id.map_fragment
...
import com.kanishak.voy.BuildConfig
import com.kanishak.voy.MainActivity
import com.kanishak.voy.R
import com.kanishak.voy.adapter.RideAdapter
import com.kanishak.voy.api.ApiService
import com.kanishak.voy.api.DataStoreManager
import com.kanishak.voy.api.RetrofitInstance
import com.kanishak.voy.api.RetrofitInstance.mapApi
...
import com.kanishak.voy.api.dataclasses.LocationPoint
import com.kanishak.voy.api.dataclasses.User
import com.kanishak.voy.api.dataclasses.UserXX
import com.kanishak.voy.api.dataclasses.UserXXX
import com.kanishak.voy.api.dataclasses.mapsDataClasses.OriginDestination
import com.kanishak.voy.api.dataclasses.mapsDataClasses.Route
import com.kanishak.voy.api.dataclasses.mapsDataClasses.RouteModifiers
...
import com.kanishak.voy.databinding.ActivityMapBinding
import com.kanishak.voy.geocoding_helper.GeocodingHelper
import com.kanishak.voy.geocoding_helper.GeocodingResult
import com.kanishak.voy.mapRoute.drawRouteOnMap
    ...
    suspend fun getRoute(
        ...
        val request = RoutesRequest(
            origin = OriginDestination(
                com.kanishak.voy.api.dataclasses.mapsDataClasses.Location(
                    origin
                )
